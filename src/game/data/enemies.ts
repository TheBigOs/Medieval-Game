...
const TEMPLATES: Record<string, EnemyTemplate> = {
  ...
  zombie: {
    templateId: 'zombie',
    name: 'Village Zombie',
    description: 'A former villager, now a shambling husk of rot and hunger. Its jaw hangs slack, eyes clouded white.',
    maxHp: 14,
    ac: 10,
    attackBonus: 1,
    damageDice: '1d6',
  ...
  zombie_barkeep: {
    templateId: 'zombie_barkeep',
    name: 'Zombie Barkeep',
    description: 'Still wearing its stained apron, the dead innkeeper lurches forward with a broken bottle raised.',
    maxHp: 14,
    ac: 10,
    attackBonus: 2,
    damageDice: '1d6+1',
  ...
  forge_zombie: {
    templateId: 'forge_zombie',
    name: 'Forge Zombie',
    description: "A massive dead man in a blacksmith's apron, dragging a length of heavy chain. The curse made it stronger than it was alive.",
    maxHp: 16,
    ac: 12,
    attackBonus: 3,
    damageDice: '1d8+1',
  ...
  skeleton_priest: {
    templateId: 'skeleton_priest',
    name: 'Skeleton Priest',
    description: 'A former clergyman reduced to animated bone, its hollow eye sockets burning with corrupt blue light. It raises its iron-shod staff against you.',
    maxHp: 13,
    ac: 12,
    attackBonus: 3,
    damageDice: '1d6',
  ...
  ghoul: {
    templateId: 'ghoul',
    name: 'Ghoul',
    description: 'Lower and faster than any zombie, this thing moves on all fours between the gravestones. Long claws, pale cunning eyes. It wants you.',
    maxHp: 15,
    ac: 13,
    attackBonus: 5,
    damageDice: '1d8+2',
  ...
  tomb_zombie: {
    templateId: 'tomb_zombie',
    name: 'Tomb Zombie',
    description: 'Freshly dragged from its grave, still encrusted with grave-dirt and rotting burial cloth. Fragile — but there are more of them than you would like.',
    maxHp: 8,
    ac: 8,
    attackBonus: 1,
    damageDice: '1d4',
  ...
  arch_lich: {
    templateId: 'arch_lich',
    name: 'Arch-Lich Necromancer',
    description: 'Malachar the Undying. Centuries of dark power gathered in one skeletal form. He raises one hand — and the air around you turns to ice.',
    maxHp: 50,
    ac: 17,
    attackBonus: 8,
    damageDice: '2d8+4',
